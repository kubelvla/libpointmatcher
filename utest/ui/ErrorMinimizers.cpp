...
TEST_F(ErrorMinimizerTest, ErrorElements)
{
	...
	PM::ErrorMinimizer::ErrorElements mPts(request, source, weights, matches, PM::ErrorMinimizer::Penalties(), PM::TransformationParameters(), PM::TransformationParameters());
